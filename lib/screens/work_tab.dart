  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      ...
      builder: (context, child) {
        ...
        // Filter campaigns: must be active and not fully completed, and not created by current user
        final activeCampaigns = db.campaigns.where((c) {
          ...
          if (_selectedFilter == 'YouTube' && !c.type.contains('YouTube')) return false;
          if (_selectedFilter == 'Websites' && !c.type.contains('Website')) return false;
          
          // Also hide tasks that this user already completed successfully
          final hasCompleted = db.tasks.any((t) => t.campaignId == c.id && t.workerId == user?.id && t.status == 'completed');
          return !hasCompleted;
        }).toList();
          ...
          child: Column(
            ...
            children: [
              ...
              SingleChildScrollView(
                ...
                child: Row(
                  children: ['All', 'Facebook', 'YouTube', 'Websites'].map((filter) {
